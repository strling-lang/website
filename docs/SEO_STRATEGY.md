...
| `/regex/docs/`                      | Explore canonical regex semantics    | regex feature catalog            | regular expression features, regex semantics                 | Every category, Compatibility Explorer            |
| `/regex/docs/<category>/`           | Browse one canonical category        | category-specific regex features | semantic definitions, feature relationships                  | Every constituent feature, related categories     |
| `/regex/docs/<category>/<feature>/` | Understand one semantic feature      | canonical feature name           | aliases, variants, manifestations, source provenance         | Canonical category, related features              |
...
- Regex feature aliases resolve through search and internal metadata to one
  canonical feature page; do not create alias landing pages or repeat aliases
  for keyword density.
